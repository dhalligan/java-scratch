...
public class Main
{
    ...
    public static void commandlineMain(){
        System.out.println("Hello world interactive!");
	MyTest test = new MyTest();
	test.run();

	StringAlgorithm stringAlgorithm = new StringAlgorithm();
	String test_str_1 = "this is a test";
	String test_str_2 = "abcdefgh";
	boolean r_1 = stringAlgorithm.uniqueChars(test_str_1);
	boolean r_2 = stringAlgorithm.uniqueChars(test_str_2);
	System.out.println("Result 1: " + r_1);
	System.out.println("Result 2: " + r_2);
	
	String test_str_3 = "palindrome";
	String test_str_4 = "A man a plan a canal... panama!";
	boolean r_3 = stringAlgorithm.palindromic(test_str_3);
	boolean r_4 = stringAlgorithm.palindromic(test_str_4);
	System.out.println("Result 3: " + r_3);
	System.out.println("Result 4: " + r_4);

	String result_str_3 = stringAlgorithm.reverse(test_str_3);
	System.out.println("Reverse: " + result_str_3);

	String test_str_5 = "A2";
	int test_str_5_val = stringAlgorithm.stringToInteger(test_str_5, 16);
	System.out.println("Value of string 523: " + test_str_5_val);

	String test_int_str_1 = stringAlgorithm.integerToString(24, 2);
	String test_int_str_2 = stringAlgorithm.integerToString(24, 16);
	System.out.println("String of 24 in base 2: " + test_int_str_1);
	System.out.println("String of 24 in base 16: " + test_int_str_2);
	
	String lex_str_1 = "abcde";
	String lex_str_2 = "abcd";
	System.out.println("Compare (a, b) = " + stringAlgorithm.compare(lex_str_1, lex_str_2));
	
	String excel_str = "AB";
	System.out.println("Excel string AB has value: " + stringAlgorithm.ssDecodeColId(excel_str));
